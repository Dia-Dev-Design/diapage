 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,z){var I=_.length;_.push(z);e:for(;0<I;){var U=I-1>>>1,H=_[U];if(0<i(H,z))_[U]=z,_[I]=H,I=U;else break e}}function n(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var z=_[0],I=_.pop();if(I!==z){_[0]=I;e:for(var U=0,H=_.length,en=H>>>1;U<en;){var Ge=2*(U+1)-1,kt=_[Ge],_e=Ge+1,dt=_[_e];if(0>i(kt,I))_e<H&&0>i(dt,kt)?(_[U]=dt,_[_e]=I,U=_e):(_[U]=kt,_[Ge]=I,U=Ge);else if(_e<H&&0>i(dt,I))_[U]=dt,_[_e]=I,U=_e;else break e}}return z}function i(_,z){var I=_.sortIndex-z.sortIndex;return I!==0?I:_.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,s=l.now();e.unstable_now=function(){return l.now()-s}}var a=[],c=[],f=1,d=null,g=3,w=!1,v=!1,x=!1,C=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(_){for(var z=n(c);z!==null;){if(z.callback===null)r(c);else if(z.startTime<=_)r(c),z.sortIndex=z.expirationTime,t(a,z);else break;z=n(c)}}function S(_){if(x=!1,m(_),!v)if(n(a)!==null)v=!0,fr(E);else{var z=n(c);z!==null&&Zt(S,z.startTime-_)}}function E(_,z){v=!1,x&&(x=!1,h(L),L=-1),w=!0;var I=g;try{for(m(z),d=n(a);d!==null&&(!(d.expirationTime>z)||_&&!Re());){var U=d.callback;if(typeof U=="function"){d.callback=null,g=d.priorityLevel;var H=U(d.expirationTime<=z);z=e.unstable_now(),typeof H=="function"?d.callback=H:d===n(a)&&r(a),m(z)}else r(a);d=n(a)}if(d!==null)var en=!0;else{var Ge=n(c);Ge!==null&&Zt(S,Ge.startTime-z),en=!1}return en}finally{d=null,g=I,w=!1}}var T=!1,j=null,L=-1,B=5,O=-1;function Re(){return!(e.unstable_now()-O<B)}function Xt(){if(j!==null){var _=e.unstable_now();O=_;var z=!0;try{z=j(!0,_)}finally{z?Jt():(T=!1,j=null)}}else T=!1}var Jt;if(typeof p=="function")Jt=function(){p(Xt)};else if(typeof MessageChannel<"u"){var gi=new MessageChannel,jl=gi.port2;gi.port1.onmessage=Xt,Jt=function(){jl.postMessage(null)}}else Jt=function(){C(Xt,0)};function fr(_){j=_,T||(T=!0,Jt())}function Zt(_,z){L=C(function(){_(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){v||w||(v=!0,fr(E))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(_){switch(g){case 1:case 2:case 3:var z=3;break;default:z=g}var I=g;g=z;try{return _()}finally{g=I}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,z){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var I=g;g=_;try{return z()}finally{g=I}},e.unstable_scheduleCallback=function(_,z,I){var U=e.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?U+I:U):I=U,_){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=I+H,_={id:f++,callback:z,priorityLevel:_,startTime:I,expirationTime:H,sortIndex:-1},I>U?(_.sortIndex=I,t(c,_),n(a)===null&&_===n(c)&&(x?(h(L),L=-1):x=!0,Zt(S,I-U))):(_.sortIndex=H,t(a,_),v||w||(v=!0,fr(E))),_},e.unstable_shouldYield=Re,e.unstable_wrapCallback=function(_){var z=g;return function(){var I=g;g=z;try{return _.apply(this,arguments)}finally{g=I}}}})(af);sf.exports=af;var om=sf.exports;/**
 * @license React
...
`,Lw=()=>{const e=$u(),t=()=>{e("/")},n=async()=>{t(),setTimeout(()=>{const r=document.getElementById("contact");r&&window.scrollTo({top:r.getBoundingClientRect().top,behavior:"smooth"})},1)};return u.jsxs(Tw,{children:[u.jsx(Pw,{onClick:t,src:jw}),u.jsxs(Rw,{children:["<",u.jsx(Ew,{children:"Día:"})," Dev & Design>"]}),u.jsxs(_w,{children:[u.jsx(Ud,{to:"/",children:"Home"}),u.jsx(Ud,{to:"/about",children:"About Us"}),u.jsx(Aw,{onClick:n,children:"Contact Us"})]})]})},zw=y.div`
  ...
  align-items: inherit;
  align-self: inherit;
`,Yt=({children:e})=>u.jsx(zw,{children:e}),Iw=y.div`
  height: 85vh;
  width: 100%;
  padding: 0;
  margin: 0;
...
`,Fw=()=>{const e=()=>{window.scrollTo({top:document.body.scrollHeight,behavior:"smooth"})};return u.jsx(Iw,{children:u.jsx(Yt,{children:u.jsxs(Nw,{children:[u.jsxs($w,{children:[u.jsxs(Wi,{children:["Every-",u.jsx(Hd,{id:"dia",children:"Día"}),". "]}),u.jsx(Wi,{children:"We build."}),u.jsx(Wi,{children:"We create."}),u.jsxs(Wi,{children:["You ",u.jsx(Hd,{id:"dia",children:"succeed"}),"!"]}),u.jsx(Dw,{children:"We partner with you to craft tailored applications that meet your unique requirements, operational needs, and strategic goals. Our focus is on efficiency, productivity, and innovation."}),u.jsx(Ow,{onClick:e,children:"Contact Us"})]}),u.jsx(bw,{children:u.jsx("img",{src:Kh,alt:"header-image"})})]})})})},Bw=y.div`
  width: 100%;
  height: 100vh;
  background-color: #f2f2f2;
  display: flex;
...
`,qi=y.p`
  ...
  text-align: justify;
  margin-top: 5%;
`,Jw=()=>u.jsx(Bw,{children:u.jsx(Yt,{children:u.jsxs(Mw,{children:[u.jsxs(Uw,{children:[u.jsx(Hw,{children:"We Are"}),u.jsxs(Ww,{children:[u.jsx("p",{children:"We are committed to empowering your business with cutting-edge solutions that align with your goals."}),u.jsx("p",{children:"Our primary focus is on delivering customized technology that caters to your unique requirements."}),u.jsx("p",{children:"Simultaneously, we support our community through continuous learning and creative collaboration, turning our efforts into sustainable, fulfilling careers and successful businesses."})]})]}),u.jsxs(Vw,{children:[u.jsx(Qw,{children:"What We Do"}),u.jsxs(Kw,{children:[u.jsxs(Gw,{children:[u.jsx(Vi,{children:u.jsx(Qi,{src:Gh,alt:"web-dev"})}),u.jsxs(Ki,{children:[u.jsx(Gi,{children:"Web Development"}),u.jsx(qi,{children:"Save time and cut costs with automated, streamlined processes. Safeguard your data and observe compliance with advanced measures and best practices. Keep your software up-to-date and optimized with ongoing care."})]})]}),u.jsxs(qw,{children:[u.jsx(Vi,{children:u.jsx(Qi,{src:qh,alt:"custom-applications"})}),u.jsxs(Ki,{children:[u.jsx(Gi,{children:"Custom Applications"}),u.jsx(qi,{children:"Solutions for your unique business needs and goals. Applications that evolve as your business grows. Seamlessly compatible with all devices and screen sizes. Intuitive design and engaging interfaces."})]})]}),u.jsxs(Yw,{children:[u.jsx(Vi,{children:u.jsx(Qi,{src:Yh,alt:"problem-solutions"})}),u.jsxs(Ki,{children:[u.jsx(Gi,{children:"Marketing"}),u.jsx(qi,{children:"Solutions that address your specific challenges. Fast and efficient responses that minimize downtime and disruption. Drive savings through swift and effective issue resolution."})]})]}),u.jsxs(Xw,{children:[u.jsx(Vi,{children:u.jsx(Qi,{src:Xh,alt:"tech-talent-incubator"})}),u.jsxs(Ki,{children:[u.jsx(Gi,{children:"Tech Incubator"}),u.jsx(qi,{children:"If feel you have a really marketable tech concept that needs help, we are ready to take your business concept and, with our focus on excellence, turn it into a product the changes the world!"})]})]})]})]})]})})}),Zw=y.section`
  display: flex;
  flex-direction: column;
  align-items: center;
  height: 100vh;
...
`,h3=()=>{const[e,t]=R.useState([]),[n,r]=R.useState(null),[i,o]=R.useState({name:"",email:"",message:""}),[l,s]=R.useState(""),a=(d,g)=>{let w=[...e],v=w.findIndex(x=>x===g);v>-1?w.splice(v,1):w.push(g),t(w)},c=d=>{o(g=>({...g,[d.target.name]:d.target.value}))},f=d=>{d.preventDefault(),C0("/send-email",{emailContent:i,subjectsSelected:e}).then(g=>{console.log(g.data.message),s(g.data.message),t([]),o({name:"",email:"",message:""}),setTimeout(()=>{s("")},4500)}).catch(g=>{console.log(g)})};return R.useEffect(()=>{document.addEventListener("mousedown",()=>r(null))},[]),u.jsx(Zw,{children:u.jsx(Yt,{children:u.jsxs(t3,{id:"contact",children:[u.jsxs(n3,{children:[u.jsx(e3,{children:"Get In Touch"}),u.jsxs(i3,{children:["Let’s discuss something ",u.jsx(o3,{children:"cool"})," together!"]}),u.jsxs(a3,{children:[u.jsx("span",{children:u.jsx("img",{src:j0})}),u.jsx("span",{style:{color:"white",fontSize:"2rem",fontWeight:"500"},children:"info@diadevdesign.com"})]})]}),l?u.jsx("p",{style:{whiteSpace:"pre-wrap",color:"white",fontFamily:"Aileron-Bold",fontSize:"3.6rem",fontWeight:"900"},children:l}):u.jsxs(r3,{children:[u.jsx(s3,{src:E0,alt:"Dog Image"}),u.jsx(l3,{children:u.jsxs(u3,{children:[u.jsx("span",{children:"I’m interested in..."}),u.jsxs(c3,{children:[u.jsx(Pn,{$active:e.includes("Web Development"),value:"Web Development",onClick:d=>a(d,"Web Development"),children:"Web Development"},"button-1"),u.jsx(Pn,{$active:e.includes("UX/UI Design"),value:"UX/UI Design",onClick:d=>a(d,"UX/UI Design"),children:"UX/UI Design"},"button-2"),u.jsx(Pn,{$active:e.includes("Graphic Design"),value:"Graphic Design",onClick:d=>a(d,"Graphic Design"),children:"Marketing"},"button-3"),u.jsx(Pn,{$active:e.includes("Custom APIs"),value:"Custom APIs",onClick:d=>a(d,"Custom APIs"),children:"Custom APIs"},"button-5"),u.jsx(Pn,{$active:e.includes("AI Apps/Agents"),value:"AI Apps/Agents",onClick:d=>a(d,"AI Apps/Agents"),children:"AI Apps/Agents"},"button-6"),u.jsx(Pn,{$active:e.includes("Other"),value:"Other",onClick:d=>a(d,"Other"),children:"Other"},"button-7")]}),u.jsxs(d3,{onSubmit:f,children:[u.jsx(cs,{htmlFor:"name",$active:n==="input-1",children:"Your Name"}),u.jsx(Wd,{type:"text",name:"name",value:i.name,$active:n==="input-1",onClick:()=>r("input-1"),onChange:d=>c(d)}),u.jsx(cs,{htmlFor:"email",$active:n==="input-2",children:"Your Email"}),u.jsx(Wd,{type:"email",name:"email",value:i.email,$active:n==="input-2",onClick:()=>r("input-2"),onChange:d=>c(d)}),u.jsx(cs,{htmlFor:"message",$active:n==="input-3",children:"Your Message"}),u.jsx(f3,{type:"text",name:"message",value:i.message,$active:n==="input-3",onClick:()=>r("input-3"),onChange:d=>c(d)}),u.jsxs(p3,{type:"submit",children:[u.jsx("img",{src:k0,alt:"send message"}),u.jsx("p",{children:"Send Message"})]})]})]})})]})]})})})},m3=y.div`
  ...
  justify-content: center;
  width: 100%;
`,g3=()=>u.jsxs(m3,{children:[u.jsx(Fw,{}),u.jsx(Jw,{}),u.jsx(h3,{})]}),y3=Ih`
